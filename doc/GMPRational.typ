...
- CMake configuration
- Register dialect in asl-opt

== Phase 2: Z Types and Basic Ops
- `!gmp.z` type
- Construction: `zero`, `one`, `of_string`, `of_i64`
- Basic arithmetic: `add`, `sub`, `mul`, `neg`, `abs`

== Phase 3: Z Division
- Truncated: `div`, `rem`, `div_rem`
- Floor: `fdiv`
- Ceiling: `cdiv`
- Euclidean: `ediv`, `erem`
- Exact: `divexact`

== Phase 4: Z Bitwise and Comparison
- Bitwise: `logand`, `logor`, `logxor`, `lognot`
- Shifts: `shift_left`, `shift_right`
- Comparisons: `compare`, `equal`, `lt`, `le`, `gt`, `ge`
- Bit operations: `testbit`, `popcount`, `numbits`

== Phase 5: Z Number Theory
- GCD/LCM: `gcd`, `gcdext`, `lcm`
- Modular: `powm`, `invert`
- Primality: `probab_prime`, `nextprime`
- Combinatorics: `fac`, `bin`, `fib`

== Phase 6: Q Module
- `!gmp.q` type
- Construction: `zero`, `one`, `make`, `of_bigint`, `of_string`
- Arithmetic: `add`, `sub`, `mul`, `div`, `neg`, `abs`, `inv`
- Access: `num`, `den`
- Comparison: `compare`, `equal`, `lt`, `gt`, `sign`

== Phase 7: Constant Folding
- APInt-based Z folding
- APRational-based Q folding
- Canonicalization patterns

== Phase 8: GMP Lowering
- Z operations → `mpz_*` calls
- Q operations → `mpq_*` calls
- EmitC integration
